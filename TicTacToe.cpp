...
using namespace std;
int cell[10];
int selected, player, gameOver, timeLeft, menuSelect = 1, started = 0, change;
HANDLE handle = GetStdHandle(STD_OUTPUT_HANDLE);
bool moveMade, pvpMoveMade;
...
void launch()
{
	...
	cout << "#" << setw(28);
	cout << "Play against player" << setw(11) << "#" << endl;
...
void graphics()
{
	...
	switch (started)
	{
	case(1):cout << "against computer" << endl; break;
	case(2):cout << "against computer" << endl; break;
	case(3):cout << "against player" << endl; break;
	case(4):cout << "against player" << endl; break;
	}
	if (started > 2)
	{
		colorText(3);
		cout << "Player turn: ";
		colorText(1);
		if ((change == 1) && (started == 3)) { cout << "X" << endl; }
		if ((change == 2) && (started == 3)) { cout << "O" << endl; }
		if ((change == 1) && (started == 4)) { cout << "O" << endl; }
		if ((change == 2) && (started == 4)) { cout << "X" << endl; }
	}
}
...
void rezCheck(int s)
{
	...
	{
		//Player X wins
		if ((cell[0] == p1) && (cell[1] == p1) && (cell[2] == p1)) gameOver = 4;
		if ((cell[3] == p1) && (cell[4] == p1) && (cell[5] == p1)) gameOver = 4;
		if ((cell[6] == p1) && (cell[7] == p1) && (cell[8] == p1)) gameOver = 4;
		if ((cell[0] == p1) && (cell[3] == p1) && (cell[6] == p1)) gameOver = 4;
		if ((cell[1] == p1) && (cell[4] == p1) && (cell[7] == p1)) gameOver = 4;
		if ((cell[2] == p1) && (cell[5] == p1) && (cell[8] == p1)) gameOver = 4;
		if ((cell[0] == p1) && (cell[4] == p1) && (cell[8] == p1)) gameOver = 4;
		if ((cell[2] == p1) && (cell[4] == p1) && (cell[6] == p1)) gameOver = 4;
		//Computer O wins
		if ((cell[0] == p2) && (cell[1] == p2) && (cell[2] == p2)) gameOver = 5;
		if ((cell[3] == p2) && (cell[4] == p2) && (cell[5] == p2)) gameOver = 5;
		if ((cell[6] == p2) && (cell[7] == p2) && (cell[8] == p2)) gameOver = 5;
		if ((cell[0] == p2) && (cell[3] == p2) && (cell[6] == p2)) gameOver = 5;
		if ((cell[1] == p2) && (cell[4] == p2) && (cell[7] == p2)) gameOver = 5;
		if ((cell[2] == p2) && (cell[5] == p2) && (cell[8] == p2)) gameOver = 5;
		if ((cell[0] == p2) && (cell[4] == p2) && (cell[8] == p2)) gameOver = 5;
		if ((cell[2] == p2) && (cell[4] == p2) && (cell[6] == p2)) gameOver = 5;
	}
	if (s == 4)
	{
		//Player O wins
		if ((cell[0] == p1) && (cell[1] == p1) && (cell[2] == p1)) gameOver = 5;
		if ((cell[3] == p1) && (cell[4] == p1) && (cell[5] == p1)) gameOver = 5;
		if ((cell[6] == p1) && (cell[7] == p1) && (cell[8] == p1)) gameOver = 5;
		if ((cell[0] == p1) && (cell[3] == p1) && (cell[6] == p1)) gameOver = 5;
		if ((cell[1] == p1) && (cell[4] == p1) && (cell[7] == p1)) gameOver = 5;
		if ((cell[2] == p1) && (cell[5] == p1) && (cell[8] == p1)) gameOver = 5;
		if ((cell[0] == p1) && (cell[4] == p1) && (cell[8] == p1)) gameOver = 5;
		if ((cell[2] == p1) && (cell[4] == p1) && (cell[6] == p1)) gameOver = 5;
		//Computer X wins
		if ((cell[0] == p2) && (cell[1] == p2) && (cell[2] == p2)) gameOver = 4;
		if ((cell[3] == p2) && (cell[4] == p2) && (cell[5] == p2)) gameOver = 4;
		if ((cell[6] == p2) && (cell[7] == p2) && (cell[8] == p2)) gameOver = 4;
		if ((cell[0] == p2) && (cell[3] == p2) && (cell[6] == p2)) gameOver = 4;
		if ((cell[1] == p2) && (cell[4] == p2) && (cell[7] == p2)) gameOver = 4;
		if ((cell[2] == p2) && (cell[5] == p2) && (cell[8] == p2)) gameOver = 4;
		if ((cell[0] == p2) && (cell[4] == p2) && (cell[8] == p2)) gameOver = 4;
		if ((cell[2] == p2) && (cell[4] == p2) && (cell[6] == p2)) gameOver = 4;
	}
}
...
int main()
{
	...
	for (int i = 0; i < 7; i++)
	{
		...
		if (gameOver == 2) w1 = 24;
		if (gameOver == 3) w1 = 20;
		if ((gameOver == 4) || (gameOver == 5)) w1 = 25;
		cout << "#" << setw(w1);
		...
		if (gameOver == 4) { colorText(3); cout << "Player X wins!"; w2 = 14; colorText(1); }
		if (gameOver == 5) { colorText(3); cout << "Player O wins!"; w2 = 14; colorText(1); }
		colorText(1);
		cout << setw(w2) << "#" << endl;
